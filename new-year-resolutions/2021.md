...
* Other challenges I am considering:
  ...
  - something involving Duolingo (now that I finally managed to make the leagues disappear, using [uBlock Origin](https://addons.mozilla.org/en-US/firefox/addon/ublock-origin/) as described [here](https://forum.duolingo.com/comment/33039989/How-to-block-the-Leagues))

...
* October: 🔴 For another [project](https://doi.org/10.3897/rio.11.e179253) I am involved in, we started [exploring Codeberg](https://codeberg.org/find-software) but we ran into problems there and thus switched to GitHub for the time being.
* November: 🟢 started beta-testing the new version of the ARPHA platform, hopefully to be released soon
* December: 🟢 started using [Ecosia AI](https://blog.ecosia.org/ecosia-ai/) for most of my LLM-related activities

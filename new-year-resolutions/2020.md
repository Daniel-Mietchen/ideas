...
On the practicalities of 100 day challenges, I am currently using Duolingo as a testbed, allowing for the use of what they call Streak freezes. Progress can be followed [here](https://duome.eu/EvoMRI). I am also experimenting with a daily dose of CodeCombat. The ongoing COVID-19 pandemic makes it hard to plan anything for the near future, though, so doing something for 100 days in a row might not actually be feasible.
